...
| `OUT=\```                | Command Sub    | Sostituisce il comando con l'output prodotto su stdout (sintassi **backticks**).                                                                                                                                      | 112         |
...
## VII. Accesso Remoto SSH (Secure Shell)
...
## VIII. Script Base e Modelli (Boilerplate)
