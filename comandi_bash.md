...
| `<cmd1>`\|`<cmd2>`                          | Pipe           | Collega lo standard output di `cmd1` allo standard input di `cmd2` (i processi eseguono in contemporanea in subshell).                                                                                                    | 156         |
| `<cmd1>`\|&`<cmd2>`                         | Pipe All       | Collega **stdout e stderr** di `cmd1` allo standard input di `cmd2` (scorciatoia per `2>&1 \|`).                                                                                                                          | 166         |
...
| `OUT=`\`./<file.exe>\`<br>(importanti i ``) | Command Sub    | Sostituisce il comando con l'output prodotto su stdout (sintassi **backticks**).                                                                                                                                          | 112         |
